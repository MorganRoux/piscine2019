...
/*   Updated: 2019/08/13 10:19:47 by mroux            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(void)
{
	...
	printf("! : %s\n", ft_convert_base(".", ".123456789", "!123456789"));
	printf("! : %s\n", ft_convert_base("0", ".1234?6789", "!1234&6789"));
	printf("& : %s\n", ft_convert_base("?", ".1234?6789", "!1234&6789"));
	printf("25695 : %s\n", ft_convert_base("25695", "0123456789", "!123456789"));
	printf("25!695 : %s\n", ft_convert_base("0250695", "0123456789", "!123456789"));
	printf("! : %s\n", ft_convert_base("--+-0 16", "0123456789", "!123456789ABCDEF"));
	printf(“0 : %s\n", ft_convert_base("+	16", "0123456789", "01"));
	printf("10000 : %s\n", ft_convert_base(" 	--+--16", "0123456789", "01"));
	printf("NULL : %s\n", ft_convert_base(" 	--+--16", "0123456789", "1"));
	printf("5 : %s\n", ft_convert_base("--5", "0123456789", "!123456789ABCDEF"));
	printf("! : %s\n", ft_convert_base("--+-0 16", "0123456789", "!123456789ABCDEF"));
	printf("-10 : %s\n", ft_convert_base("--+-16", "0123456789", "0123456789ABCDEF"));
	printf(“! : %s\n", ft_convert_base("-- +-16", "0123456789", "!123456789ABCDEF"));
	printf("1 : %s\n", ft_convert_base("--+-FFFFFFFFiF", "0123456789ABCDEF", "0123456789abcdef"));
	printf("NULL : %s\n", ft_convert_base("+16", "01230456789", "!123456789ABCDEF"));
	printf(“! : %s\n", ft_convert_base("- -+-16", "0123456789", "!123456789ABCDEF"));
